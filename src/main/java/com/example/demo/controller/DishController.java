...
public class DishController {
    ...
    @Autowired
    private com.example.demo.service.CategoryService dishFlavorService;
...
//    }
    ...
    public R<List<DishDto>> list(Dish dish){
        ...
        List<DishDto> dishDtoList = list.stream().map((item) -> {
            ...
            //List<DishFlavor> dishFlavorList = dishFlavorService.list(dishFlavorService);
